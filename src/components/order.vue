...
<script>
	export default {
		...
		created() {
			this.axios.get('http://10.0.157.235:8888/getList?pageNum=1&pageSize=3')
			.then(res => {
...
<style lang="css" scoped>
	*{
	...
	.right_{
		...
		height: 1.342105rem;
		float: right;	
		border-bottom: 0.026315rem solid #e0e0e0;
		position: relative;
	}
	#div_head a{
		...
		font-weight: bold;
		color: #333333;
		margin-bottom: 0.473684rem;
		position: absolute;
		top: 0.447368rem;
		background: url(../../static/order_img/未标题-1.gif) center right no-repeat;
		display: block;
		width: 2rem;
	}
	#div_head span{
	...
	.div_center ul li span:nth-of-type(2){
		position: absolute;
		right: 0.394736rem;
		
	}
	.div_center ul li:nth-last-child{
	...
	.div_bottom button:nth-of-type(1){
		height: 0.842105rem;
		width: 2.631578rem;
	...
	.div_bottom button:nth-of-type(2){
		height: 0.842105rem;
		width: 2.631578rem;
		border: 0.052631rem solid #dedede;
		border-radius: 2px;
